...
* `wdio-browserstack-service`
  * [#13340](https://github.com/webdriverio/webdriverio/pull/13340) V9 ai support ([@xxshubhamxx](https://github.com/xxshubhamxx))
* `webdriverio`
...
* `wdio-browser-runner`, `webdriver`, `webdriverio`
...
* `wdio-protocols`, `webdriverio`
  * [#12923](https://github.com/webdriverio/webdriverio/pull/12923) Add Selenium downloadFile command ([@ccharnkij](https://github.com/ccharnkij))
...
* `eslint-plugin-wdio`
  * [#12679](https://github.com/webdriverio/webdriverio/pull/12679) Flat ESLint support ([@MadSandwich](https://github.com/MadSandwich))

#### :bug: Bug Fix
* `wdio-appium-service`
  * [#13366](https://github.com/webdriverio/webdriverio/pull/13366) Fix Appium Shutdown Error ([@samuelfreiberg](https://github.com/samuelfreiberg))
  ...
  * [#13180](https://github.com/webdriverio/webdriverio/pull/13180) fix(@wdio/appium-service): add port to appium start command ([@vparlah](https://github.com/vparlah))
* `wdio-protocols`
  * [#13335](https://github.com/webdriverio/webdriverio/pull/13335) fix(@wdio/protocols): remove return value for navigateTo ([@christian-bromann](https://github.com/christian-bromann))
...
* `wdio-runner`
  * [#13330](https://github.com/webdriverio/webdriverio/pull/13330) fix(@wdio/runner): retry on Outdated Optimize Dep Vite errors ([@christian-bromann](https://github.com/christian-bromann))
* `webdriver`, `webdriverio`
  * [#13223](https://github.com/webdriverio/webdriverio/pull/13223) fix(webdriverio): don't support deep piercing in iframes ([@christian-bromann](https://github.com/christian-bromann))
* `webdriver`
...
* `wdio-config`
  * [#13211](https://github.com/webdriverio/webdriverio/pull/13211) Dedupe Capabilities (main) ([@EdmundasD](https://github.com/EdmundasD))
  * [#12430](https://github.com/webdriverio/webdriverio/pull/12430) [12428] CustomService is run twice ([@jemishgopani](https://github.com/jemishgopani))
* `wdio-utils`
  * [#13207](https://github.com/webdriverio/webdriverio/pull/13207) fix(@wdio/utils): Don't download chromedriver with CHROMEDRIVER_PATH  ([@johnp](https://github.com/johnp))
* `wdio-browserstack-service`
  * [#13113](https://github.com/webdriverio/webdriverio/pull/13113) Support app inside appium options (v9) ([@sriteja777](https://github.com/sriteja777))
  * [#13085](https://github.com/webdriverio/webdriverio/pull/13085) chore: Reload session support ([@sauravdas1997](https://github.com/sauravdas1997))
  * [#12951](https://github.com/webdriverio/webdriverio/pull/12951) SDK-694: Fix for showing reason for passed test (main) ([@TamsilAmani](https://github.com/TamsilAmani))
  * [#12677](https://github.com/webdriverio/webdriverio/pull/12677) update: error messages ([@07souravkunda](https://github.com/07souravkunda))
* `wdio-browser-runner`
  * [#12979](https://github.com/webdriverio/webdriverio/pull/12979) fix(@wdio/browser-runner): sanitize objects to reduce performance burden when stringifying ([@christian-bromann](https://github.com/christian-bromann))
* `wdio-logger`
  * [#12920](https://github.com/webdriverio/webdriverio/pull/12920) fix(logger): reset cursor visibility on progress clear ([@Benricheson101](https://github.com/Benricheson101))
* `webdriverio`
  * [#12884](https://github.com/webdriverio/webdriverio/pull/12884) Select proper input via ancestor label when multiple match ([@evankennedy](https://github.com/evankennedy))
* `wdio-types`
...
* `wdio-junit-reporter`
  * [#12715](https://github.com/webdriverio/webdriverio/pull/12715) fix: error counts in junit reporter ([@ASaiAnudeep](https://github.com/ASaiAnudeep))
* `wdio-cli`, `wdio-runner`, `wdio-utils`, `webdriverio`
  * [#12669](https://github.com/webdriverio/webdriverio/pull/12669) [webdriverio] Fix issue wdio log is missing in standalone mode ([@nguyencuongabcxyz](https://github.com/nguyencuongabcxyz))
...
* `webdriver`
  ...
  * [#13122](https://github.com/webdriverio/webdriverio/pull/13122) Fix reloadSession subsequent commands ([@ccharnkij](https://github.com/ccharnkij))
* `wdio-appium-service`
  * [#13045](https://github.com/webdriverio/webdriverio/pull/13045) Add logFilters appium server args type ([@dprevost-LMI](https://github.com/dprevost-LMI))
* `wdio-types`
  * [#13047](https://github.com/webdriverio/webdriverio/pull/13047) Add maskCommands type for `bstack:options` ([@dprevost-LMI](https://github.com/dprevost-LMI))
  ...
  * [#12845](https://github.com/webdriverio/webdriverio/pull/12845) Add resignApp capability type ([@dprevost-LMI](https://github.com/dprevost-LMI))
* `webdriver`, `webdriverio`
  * [#13019](https://github.com/webdriverio/webdriverio/pull/13019) Allows reloadSession to connect to remote driver ([@ccharnkij](https://github.com/ccharnkij))
* `wdio-allure-reporter`, `webdriver`
  * [#12982](https://github.com/webdriverio/webdriverio/pull/12982) feat: display command name for webdriver calls in allure reporter ([@sudharsan-selvaraj](https://github.com/sudharsan-selvaraj))
* `wdio-browserstack-service`
  * [#12930](https://github.com/webdriverio/webdriverio/pull/12930) SDK-667 : Limit VCS info to 64kb ([@TamsilAmani](https://github.com/TamsilAmani))
  * [#12708](https://github.com/webdriverio/webdriverio/pull/12708) fix: Fix skip test filename ([@sauravdas1997](https://github.com/sauravdas1997))
* `wdio-allure-reporter`
  * [#12852](https://github.com/webdriverio/webdriverio/pull/12852) [#11473] - Refactor wdio-allure-reporter package for better hooks handling ([@lararojasmr](https://github.com/lararojasmr))
* `wdio-browser-runner`, `wdio-browserstack-service`
  * [#12847](https://github.com/webdriverio/webdriverio/pull/12847) Fix: Result and Context arguments for component tests (v9) ([@sriteja777](https://github.com/sriteja777))
...
* Other
  ...
  * [#13011](https://github.com/webdriverio/webdriverio/pull/13011) feat: new blogpost (#13008) ([@wswebcreation](https://github.com/wswebcreation))
  * [#13007](https://github.com/webdriverio/webdriverio/pull/13007) Ws/update-visual-docs (#12984) ([@wswebcreation](https://github.com/wswebcreation))
  * [#12749](https://github.com/webdriverio/webdriverio/pull/12749) A11y-Testing-bstack ([@JohnJoser3](https://github.com/JohnJoser3))
  * [#12777](https://github.com/webdriverio/webdriverio/pull/12777) docs: fix typo ([@sangcnguyen](https://github.com/sangcnguyen))
* `webdriverio`
...
* `wdio-cli`
  * [#12929](https://github.com/webdriverio/webdriverio/pull/12929) Ws/ocr-v9 ([@wswebcreation](https://github.com/wswebcreation))
...
* `wdio-runner`, `webdriverio`
  * [#12490](https://github.com/webdriverio/webdriverio/pull/12490) (webdriverio): allow getHTML to pierce through Shadow DOM ([@christian-bromann](https://github.com/christian-bromann))

#### :rocket: New Feature
* `wdio-allure-reporter`, `wdio-appium-service`, `wdio-browser-runner`, `wdio-browserstack-service`, `wdio-cli`, `wdio-concise-reporter`, `wdio-config`, `wdio-cucumber-framework`, `wdio-devtools-service`, `wdio-dot-reporter`, `wdio-firefox-profile-service`, `wdio-globals`, `wdio-jasmine-framework`, `wdio-json-reporter`, `wdio-junit-reporter`, `wdio-local-runner`, `wdio-reporter`, `wdio-sauce-service`, `wdio-shared-store-service`, `wdio-smoke-test-reporter`, `wdio-spec-reporter`, `wdio-static-server-service`, `wdio-sumologic-reporter`, `wdio-testingbot-service`, `wdio-utils`, `wdio-webdriver-mock-service`, `webdriver`, `webdriverio`
  * [#12598](https://github.com/webdriverio/webdriverio/pull/12598) Support mocking interface for Bidi ([@christian-bromann](https://github.com/christian-bromann))
* `webdriverio`
  * [#12542](https://github.com/webdriverio/webdriverio/pull/12542) (webdriverio): add execute commands to the element scope/object ([@erwinheitzman](https://github.com/erwinheitzman))
* `wdio-utils`, `wdio-webdriver-mock-service`, `webdriverio`
  * [#12529](https://github.com/webdriverio/webdriverio/pull/12529) feat(webdriverio): enable re-fetching of elements when called via `$` command ([@christian-bromann](https://github.com/christian-bromann))

#### :bug: Bug Fix
* `wdio-browserstack-service`
  * [#12584](https://github.com/webdriverio/webdriverio/pull/12584) [browserstack-service] fix cucumber test duration ([@samarsault](https://github.com/samarsault))
* `webdriver`
  * [#12579](https://github.com/webdriverio/webdriverio/pull/12579) add request.performance type to WebdriverClassicEvents ([@sushantsoni5392](https://github.com/sushantsoni5392))
* `wdio-globals`
  * [#12499](https://github.com/webdriverio/webdriverio/pull/12499) @wdio/globals: Declare "expect" global type explicitly ([@naruaway](https://github.com/naruaway))
* `wdio-browser-runner`, `webdriverio`
  * [#12539](https://github.com/webdriverio/webdriverio/pull/12539) (wdio-browser-runner): fix error response for the wdio-browser-runner ([@erwinheitzman](https://github.com/erwinheitzman))
* `wdio-browser-runner`, `wdio-mocha-framework`, `wdio-runner`, `wdio-utils`, `webdriverio`
  * [#12498](https://github.com/webdriverio/webdriverio/pull/12498) (webdriverio): fix scope management for nested calls in browser runner ([@christian-bromann](https://github.com/christian-bromann))
* `wdio-allure-reporter`
  * [#12480](https://github.com/webdriverio/webdriverio/pull/12480) [allure-report] handle case for broken status of tests with retry ([@a-skindzer](https://github.com/a-skindzer))
* Other
  * [#12487](https://github.com/webdriverio/webdriverio/pull/12487) ci: Remove "--" that breaks argv.parse() ([@seanpoulter](https://github.com/seanpoulter))

#### :nail_care: Polish
* `wdio-browser-runner`, `wdio-cli`, `wdio-cucumber-framework`, `wdio-runner`, `webdriverio`
  * [#12593](https://github.com/webdriverio/webdriverio/pull/12593) (webdriverio): render shadow elements into proper declarative shadow doms ([@christian-bromann](https://github.com/christian-bromann))
* `webdriverio`
  * [#12533](https://github.com/webdriverio/webdriverio/pull/12533) (webdriverio): polish intercepted errors ([@erwinheitzman](https://github.com/erwinheitzman))
  * [#12491](https://github.com/webdriverio/webdriverio/pull/12491) (webdriverio): polish isElementClickable ([@erwinheitzman](https://github.com/erwinheitzman))

#### :memo: Documentation
* Other
  * [#12627](https://github.com/webdriverio/webdriverio/pull/12627) docs: Remove link to Gitter ([@seanpoulter](https://github.com/seanpoulter))
  ...
  * [#12549](https://github.com/webdriverio/webdriverio/pull/12549) Fix link formatting in babel docs ([@albertyw](https://github.com/albertyw))
  * [#12531](https://github.com/webdriverio/webdriverio/pull/12531) Update mocking.md ([@LittleDC](https://github.com/LittleDC))
  * [#12525](https://github.com/webdriverio/webdriverio/pull/12525) New feature - Add NFR feature like Visual and Accessibility testing ([@syamphaneendra](https://github.com/syamphaneendra))
* `wdio-types`
  * [#12621](https://github.com/webdriverio/webdriverio/pull/12621) Updating Sauce Labs specific capability type definitions ([@steilerDev](https://github.com/steilerDev))
* `wdio-browserstack-service`
  ...
  * [#12523](https://github.com/webdriverio/webdriverio/pull/12523) Docs-update-browserstack-test-observability-webdriverio ([@JohnJoser3](https://github.com/JohnJoser3))
* `wdio-cli`
...
* `webdriverio`
  * [#12493](https://github.com/webdriverio/webdriverio/pull/12493) docs($): update example string ([@rwaskiewicz](https://github.com/rwaskiewicz))

#### :house: Internal
* [#12628](https://github.com/webdriverio/webdriverio/pull/12628) Use maintained `npm-run-all2` ([@voxpelli](https://github.com/voxpelli))
...
* `wdio-cli`, `wdio-crossbrowsertesting-service`, `wdio-types`
  * [#12433](https://github.com/webdriverio/webdriverio/pull/12433) (@wdio/crossbrowsertesting-service): remove integration to CrossBrowserTesting platform ([@christian-bromann](https://github.com/christian-bromann))
* `devtools`, `wdio-allure-reporter`, `wdio-browser-runner`, `wdio-cli`, `wdio-devtools-service`, `wdio-types`, `wdio-utils`, `webdriver`, `webdriverio`
  * [#12301](https://github.com/webdriverio/webdriverio/pull/12301) (devtools): removing `devtools` automation protocol ([@christian-bromann](https://github.com/christian-bromann))
* `wdio-cli`, `wdio-config`
  * [#12370](https://github.com/webdriverio/webdriverio/pull/12370) (wdio-config): change order of the specs when using --multi-run ([@erwinheitzman](https://github.com/erwinheitzman))
* `wdio-browser-runner`, `wdio-protocols`, `wdio-webdriver-mock-service`, `webdriver`, `webdriverio`
  * [#12006](https://github.com/webdriverio/webdriverio/pull/12006) V9 Remove JSONWireProtocol ([@tamil777selvan](https://github.com/tamil777selvan))
* `webdriverio`
  * [#11857](https://github.com/webdriverio/webdriverio/pull/11857) (webdriverio): merge isDisplayed and isDisplayedWithinViewport ([@christian-bromann](https://github.com/christian-bromann))

#### :rocket: New Feature
* `wdio-browser-runner`, `wdio-globals`, `wdio-runner`, `wdio-types`, `webdriver`, `webdriverio`
  * [#12446](https://github.com/webdriverio/webdriverio/pull/12446) (webdriverio): implement deep lookup with Bidi ([@christian-bromann](https://github.com/christian-bromann))
* `wdio-browserstack-service`
  * [#12442](https://github.com/webdriverio/webdriverio/pull/12442) [browserstack-service] Add Funnel Data instrumentation [v9] ([@sriteja777](https://github.com/sriteja777))

#### :bug: Bug Fix
* `wdio-appium-service`
  * [#12457](https://github.com/webdriverio/webdriverio/pull/12457) Fix appium service caps for multiremote ([@ccharnkij](https://github.com/ccharnkij))
* `wdio-config`
  * [#12436](https://github.com/webdriverio/webdriverio/pull/12436) (wdio-config): check existence of ts-node/esm/transpile-only.mjs & fix a type issue ([@johnp](https://github.com/johnp))
* `wdio-browserstack-service`
  * [#12340](https://github.com/webdriverio/webdriverio/pull/12340) Browserstack observability reload session fix ([@rev-doshi](https://github.com/rev-doshi))
* `webdriverio`
  * [#12308](https://github.com/webdriverio/webdriverio/pull/12308) Updated props to optional for getText and getLocation commands ([@jemishgopani](https://github.com/jemishgopani))
* `wdio-browserstack-service`, `wdio-types`, `wdio-utils`
  * [#12302](https://github.com/webdriverio/webdriverio/pull/12302) Updating capabilities for Lamdatest & Browserstack ([@tamil777selvan](https://github.com/tamil777selvan))
* `wdio-utils`
  * [#12303](https://github.com/webdriverio/webdriverio/pull/12303) Bump @puppeteer/browsers from 1.9.1 to 2.0.1 ([@paymand](https://github.com/paymand))

#### :nail_care: Polish
* `wdio-browserstack-service`
  * [#12448](https://github.com/webdriverio/webdriverio/pull/12448) Browserstack Accessibility stability ([@07souravkunda](https://github.com/07souravkunda))
* `webdriverio`
  * [#12376](https://github.com/webdriverio/webdriverio/pull/12376) (webdriverio): polish click command, fix some issues ([@erwinheitzman](https://github.com/erwinheitzman))
  * [#12390](https://github.com/webdriverio/webdriverio/pull/12390) (webdriverio): fix action pointer parameters mapping ([@erwinheitzman](https://github.com/erwinheitzman))
  * [#12377](https://github.com/webdriverio/webdriverio/pull/12377) Add ability to click and moveTo outside the given element ([@jemishgopani](https://github.com/jemishgopani))
  * [#12335](https://github.com/webdriverio/webdriverio/pull/12335) (internal): remove dependency to devtools package ([@christian-bromann](https://github.com/christian-bromann))
* `webdriver`
...
* `wdio-allure-reporter`
  * [#12379](https://github.com/webdriverio/webdriverio/pull/12379) (wdio-allure-reporter): CompoundError: Also print error message if present ([@torbenkohlmeier](https://github.com/torbenkohlmeier))
* `wdio-devtools-service`
  * [#12344](https://github.com/webdriverio/webdriverio/pull/12344) Add feature to specify os version for the emulated device ([@jemishgopani](https://github.com/jemishgopani))

#### :memo: Documentation
* Other
  * [#12396](https://github.com/webdriverio/webdriverio/pull/12396) docs: update Appium image selector docs URL ([@ieatfood](https://github.com/ieatfood))
  * [#12373](https://github.com/webdriverio/webdriverio/pull/12373) (docs): update our best practices ([@erwinheitzman](https://github.com/erwinheitzman))
  * [#12318](https://github.com/webdriverio/webdriverio/pull/12318) docs: Updated Contributing guide to mention PNPM instead of NPM ([@jan-molak](https://github.com/jan-molak))
* `wdio-types`
  * [#12398](https://github.com/webdriverio/webdriverio/pull/12398) Add resigningEnabled capability to @wdio/types (#12397) ([@AlexRivero](https://github.com/AlexRivero))

#### :house: Internal
* Other
  * [#12395](https://github.com/webdriverio/webdriverio/pull/12395) build: Migrate to Husky v9 ([@seanpoulter](https://github.com/seanpoulter))
  * [#12394](https://github.com/webdriverio/webdriverio/pull/12394) ci: Update Expense Contribution workflow ([@seanpoulter](https://github.com/seanpoulter))
* `devtools`, `eslint-plugin-wdio`, `wdio-allure-reporter`, `wdio-appium-service`, `wdio-browser-runner`, `wdio-browserstack-service`, `wdio-cli`, `wdio-concise-reporter`, `wdio-config`, `wdio-crossbrowsertesting-service`, `wdio-cucumber-framework`, `wdio-devtools-service`, `wdio-dot-reporter`, `wdio-firefox-profile-service`, `wdio-globals`, `wdio-jasmine-framework`, `wdio-junit-reporter`, `wdio-local-runner`, `wdio-logger`, `wdio-mocha-framework`, `wdio-repl`, `wdio-reporter`, `wdio-runner`, `wdio-sauce-service`, `wdio-shared-store-service`, `wdio-smoke-test-cjs-service`, `wdio-smoke-test-reporter`, `wdio-smoke-test-service`, `wdio-spec-reporter`, `wdio-static-server-service`, `wdio-sumologic-reporter`, `wdio-testingbot-service`, `wdio-types`, `wdio-utils`, `wdio-webdriver-mock-service`, `webdriver`, `webdriverio`
  * [#11493](https://github.com/webdriverio/webdriverio/pull/11493) V9 drop support for Node.js 16 ([@erwinheitzman](https://github.com/erwinheitzman))
...
- Jemish Gopani ([@jemishgopani](https://github.com/jemishgopani))
- Johannes Pfrang ([@johnp](https://github.com/johnp))
- Kuba Holuj ([@ieatfood](https://github.com/ieatfood))
...
- Wim Selles ([@wswebcreation](https://github.com/wswebcreation))
- [@rev-doshi](https://github.com/rev-doshi)
...
* `wdio-config`
  ...
  * [#13208](https://github.com/webdriverio/webdriverio/pull/13208) fix(@wdio/utils): Do with CHROMEDRIVER_PATH (v8 backport) ([@johnp](https://github.com/johnp))
* `wdio-browserstack-service`
...
* `wdio-types`
  ...
  * [#12957](https://github.com/webdriverio/webdriverio/pull/12957) Allect to remote driver ([@ccharnkij](https://github.com/ccharnkij))
  * [#12986](https://github.com/webdriverio/webdriverio/pull/12986) fewebdriver calls in allure reporter for v8 ([@sudharsan-selvaraj](https://github.com/sudharsan-selvaraj))

#### :memo: Documentation
* `webdriverio`
  * [#13020](https://github.com/webdriverio/webdriverio/pull/13020) fix(docs): add await before mock.restore() ([@sangcnguyen](https://github.com/sangcnguyen))
* Other
  * [#13008](https://github.com/webdriverio/webdriverio/pull/13008) fest ([@wswebcreation](https://github.com/wswebcreation))
...
#### :bug: Bug Fix
  * [#12980](https://github.com/webdriverio/webdriverio/pull/12980) fix(@wdio/browser-runner): s reduce performance bur… ([@christian-bromann](https://github.com/christian-bromann))
...
#### :nail_care: Polish
* `wdio-types`
  * [#12955](https://github.com/webdriverio/webdriverio/pull/12955) Add miCapabilities ([@jochen-testingbot](https://github.com/jochen-testingbot))
* `wdio-browserstack-service`
  * [#12932](https://github.com/webdriverio/webdriverio/pull/12932) SDK-667 :  64kb v8 ([@TamsilAmani](https://github.com/TamsilAmani))
...
#### :bug: Bug Fix
  * [#12922](https://github.com/webdriverio/webdriverio/pull/12922) enticator ([@sangcnguyen](https://github.com/sangcnguyen))
* `wdio-browserstack-service`
  ...
  * [#12921](https://github.com/webdriverio/webdriverio/pull/12921) [v8] fix(logger): reogress clear ([@Benricheson101](https://github.com/Benricheson101))
...
* `wdio-utils`
  ...
  * [#12850](https://github.com/webdriverio/webdriverio/pull/12850) Upo fix the compile error ([@iamatharva](https://github.com/iamatharva))
  * [#12751](https://github.com/webdriverio/webdriverio/pull/12751) [12428] [V8] Custce ([@jemishgopani](https://github.com/jemishgopani))
  * [#12723](https://github.com/webdriverio/webdriverio/pull/12723) fix: eorter ([@ASaiAnudeep](https://github.com/ASaiAnudeep))

#### :nail_care: Polish
  * [#12855](https://github.com/webdriverio/webdriverio/pull/12855) [#11473] Refactor wdiokage for better hooks handling [v8] ([@lararojasmr](https://github.com/lararojasmr))
  * [#12851](https://github.com/webdriverio/webdriverio/pull/12851) Adtes v8 ([@dprevost-LMI](https://github.com/dprevost-LMI))
