...
We recommend to work with the example file we have in the [example](https://github.com/webdriverio/webdriverio/tree/main/examples) directory.
...
- the `@wdio/types` package provides all general types that are used across the code based, e.g. Capabilities, Options etc.
