...
* Are expected to work on public branches of the source repository and submit pull requests from that branch to the master branch. Pull requests has to be made as a draft if the work is not ready for a merge nor an initial review.
