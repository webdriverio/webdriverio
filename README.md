...
- **click(`String` css selector, `String` button, `Function` callback)**<br>Clicks on an element based on a css selector. `String` button is optional and is one of [left, middle, right].
