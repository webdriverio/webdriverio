...
describe('Source maps support for CommonJS projects', () => {
    ...
    it('should detect line number correctly', async () => {
        ...
        expect(locations).toEqual([
            'source-maps-cjs.e2e.ts:43:19',   // the line where we instantiate the Error object
            'source-maps-cjs.e2e.ts:39:12',   // fn2 calls readStack
            'source-maps-cjs.e2e.ts:35:12',   // fn1 calls fn2
            'source-maps-cjs.e2e.ts:8:38',    // fn1 called in the spec
        ])
    })
