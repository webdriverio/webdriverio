// Minimal in-process MCP server for the deepagent e2e suite: speaks the
// MCP JSON-RPC handshake over stdio and answers tools/list + tools/call.
// Every call is appended to $FIXTURE_LOG (JSONL) so tests can assert the
// exact tool-call order the agent made.
