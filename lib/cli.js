...
const SUPPORTED_SERVICES = [
    ...
    ' docker - https://github.com/stsvilik/wdio-docker-service',
    ' screenshots-cleanup - https://github.com/andriilazebnyi/wdio-screenshots-cleanup-service'
]
...
optimist
    ...
    .describe('exclude', 'specifies spec file(s) to exclude from the run')
    ...
    .string(['host', 'path', 'user', 'key', 'logLevel', 'screenshotPath', 'baseUrl', 'framework', 'reporters', 'suite', 'spec', 'exclude'])
