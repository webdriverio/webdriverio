 ...
 * <example>
    ...
    it('some testing here', function() {
        ...
        // example using an async call to populate a varable
        var generatedUserEmail = browser.call(function() {
          return generateUserAndReturnEmail()
        })
        
        browser.setValue('.email', generatedUserEmail)
