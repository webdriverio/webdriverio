/**
 *
 * Perform a drag on the screen or an element (works only on [Appium](http://appium.io/))
 *
 * @param {String=} selector   element to drag on
 * @param {Number=} startX     x coordinate where drag begins (in pixels or relative units)
 * @param {Number=} startY     y coordinate where drag begins (in pixels or relative units)
 * @param {Number=} endX       x coordinate where drag ends (in pixels or relative units)
 * @param {Number=} endY       y coordinate where drag ends (in pixels or relative units)
 * @param {Number=} touchCount how many fingers to flick with
 * @param {Number=} duration   time (in seconds) to spend performing the drag
 *
 * @uses protocol/element, protocol/elementIdLocation, protocol/elementIdSize, protocol/touchSwipe
 *
 */
