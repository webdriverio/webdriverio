 ...
 * milliseconds to have text/content. If multiple elements get queried by a given
...
let waitForText = function (selector, ms, reverse, interval) {
    /**
