...
function Multibrowser(options) {
    ...
    Object.keys(options).forEach(function(instanceName) {
         ...
         */
        instance.eventHandler.on('instance_command', function(instanceCommandId) {
            ...
            instance.eventHandler.once('instance_' + instanceCommandId, function(message) {
                /**
    ...
    this.instancesAreSynced = function(commandId) {
        return this.fullmask === this.commandState[commandId].state;
    }
...
Multibrowser.register = function(fnName, chainedCommand) {
    ...
    if(fnName === 'call') {
        return function(instances, callback) {
            ...
            this.eventHandler.on('multibrowser_' + commandId, function(finishedInstance, message) {
                 ...
                 */
                if(self.instancesAreSynced(commandId)) {
                    /**
    ...
    return function() {
        ...
        this.eventHandler.on(origin + '_' + (this.commandState.length - 1), function(instance, message) {
