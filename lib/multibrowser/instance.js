...
var InstanceConstructor = chainIt(Instance);
Object.keys(InstanceConstructor.prototype).forEach(function(fnName) {
    if(fnName.indexOf('__') === 0) {
        return;
    }

    InstanceConstructor.prototype[fnName] = PromiseHandler(fnName, InstanceConstructor.prototype[fnName]);
});
