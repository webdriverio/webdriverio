...
module.exports = function elementIdAttribute (id, attributeName) {
    ...
    if((typeof id !== 'string' && typeof id !== 'number') || typeof attributeName !== 'string') {
        return callback(new ErrorHandler.ProtocolError('number or type of arguments don\'t agree with elementIdAttribute protocol command'));
    }
    ...
    this.requestHandler.create(requestPath, arguments[arguments.length - 1]);
