 ...
 * 
 * The array of elements can be retrieved within the callback using the 'response.value' 
 * which is a collection of element ID's and can be accessed in the subsequent commands 
