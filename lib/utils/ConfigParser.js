...
class ConfigParser {
     ...
     * cli argument
     * @return {Object} List of files that should be included or excluded
     */
    setFilePathToFilterOptions (cliArgFileList, config) {
        const filesToFilter = new Set()
        const fileList = cliArgFileList.split(/,/g)
        ...
        for (let file of fileList) {
            ...
            const paramFiles = filePathList.find(paramFile => paramFile.match(file))
            if (paramFiles) {
