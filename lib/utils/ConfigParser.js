...
ConfigParser.prototype.getSpecs = function(capSpecs, capExclude) {
    ...
    if(Array.isArray(capSpecs)) {
        specs = specs.concat(this.getFilePaths(capSpecs));
    }
    if(Array.isArray(capExclude)) {
        exclude = exclude.concat(this.getFilePaths(capExclude));
    }
 ...
 * return capabilities
 */
ConfigParser.prototype.getCapabilities = function(i) {
