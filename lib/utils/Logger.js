...
var Logger = function(instance){
    ...
    this.logLevel = instance.options.logLevel;
     ...
     */
    if(!instance.options.coloredLogs) {
...
Logger.prototype.debug = function() {
    ...
    this.log(colors.yellow + 'DEBUG\t' + colors.dkgray + 'continue by pressing any the [ENTER] key ...' + colors.reset);
};
