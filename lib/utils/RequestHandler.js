        ...
        return function(response) {
            ...
            response.on('end', function() {
                ...
                if (result.status === 0) {
                    ...
                    result = {value: -1, error: errorCodes[result.status].id, status: result.status, orgStatusMessage: errorCodes[result.status].message};
                    ...
                    result = {
                        error: errorCodes[result.status].id,
