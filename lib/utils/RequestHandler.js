...
RequestHandler.prototype.create = function(requestOptions, data, callback) {
    ...
    if (this.fullRequestOptions.method === 'POST' && data && data !== '{}') {
        this.fullRequestOptions.headers['Content-Type'] = 'application/json; charset=UTF-8';
        this.fullRequestOptions.headers['Content-Length'] = Buffer.byteLength(data, 'utf8');
        this.fullRequestOptions.body = data;
    }
