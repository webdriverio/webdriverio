...
var RequestHandler = module.exports = function(options) {
    ...
    this.create = function(requestOptions, data, callback) {
        ...
        request.on("error", function(err) {
            ...
            if(err.code === 'ECONNREFUSED' && err.syscall === 'connect') {
                console.log('\n');
                log.log('Couldn\'t find a running selenium server instance on hostname ' + this.defaultOptions.hostname + ' and port ' + this.defaultOptions.port, null, true);
    ...
    this.setSessionID = function(data,response) {
        ...
        log('SET SESSION ID ' + data.sessionId);
        ...
        return function(response) {
            ...
            response.on('end', function() {
                ...
                if(this.sessionID === null && this.fullRequestOptions.requiresSession !== false) {
                    this.setSessionID(result,response);
                }
