...
function processRequest(fullRequestOptions, totalRetryCount, retryCount) {
    ...
    request(fullRequestOptions, function (err, response, body) {
        if(err || (body && body.status !== 0)) {
            ...
            processRequest(fullRequestOptions, totalRetryCount, retryCount)
...
RequestHandler.prototype.create = function(requestOptions, data) {
    ...
    return processRequest(fullRequestOptions, this.defaultOptions.connectionRetryCount).then(function (data) {
