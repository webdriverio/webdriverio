...
import detectSeleniumGrid from './helpers/detectSeleniumGrid'
...
let WebdriverIO = function (args, modifier) {
    ...
    let isGrid = detectSeleniumGrid(options)
    ...
    let reject = function (err, onRejected) {
        ...
        let screenshotPath = options.screenshotPath[0] === '/'
