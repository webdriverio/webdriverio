...
var WebdriverIO = module.exports = function WebdriverIO(options) {
    ...
    function unit(lastPromise) {
        ...
        client.next = function (func, args) {
            ...
            this.lastPromise.finally(resolve.bind(this, safeExecute(func, args)));
        };
        ...
        client.then = function(onFulfilled, onRejected) {
            ...
            /**
             * flag then context to execute commands with different scope
             * @todo this should be possible outside of then functions
             */
            client.thenContext = true;
