...
var WebdriverJs = function(host, port, username, pass) 
{
	...
	self.showCommandLog = true;
	
	self.showDataLog = true;
...
//					console.log("NEXT IN EMPTY CALLBACK")
	...
	console.log("");
	console.log("Selenium 2.0/webdriver protocol implementation with helper commands in nodejs by Camilo Tapia.");
	...
	console.log("Not all commands are implemented yet. Start with " + colors.lime + "-h option" + colors.reset + " to get a list of all commands.");
	console.log("");
	console.log(colors.yellow + "=====================================================================================" + colors.reset);
	console.log("");
...
{
	var request = this.createRequest(requestOptions, callback);
	var stringData = JSON.stringify(data);
	
	if (this.showDataLog && stringData != "{}")
	{
...
WebdriverJs.prototype.testMode = function()
{
	...
	console.log(colors.yellow + "NOW IN TEST MODE!" + colors.reset + "\n");
	return this;
};


// strip the content from unwanted charachetrs
...
WebdriverJs.prototype.createRequest = function(requestOptions, callback)
{
			...
			function() 
			{
				...
				if (self.showCommandLog)
				{
					...
					else
					{
						...
						var errorScreenshotFileName = runner + "-ERROR.AT." + self.currentQueueItem.commandName + ".png";
...
exports.remote = function(host, port, username, pass) 
{
	return new WebdriverJs(host, port, username, pass);
};
