...
var WebdriverJs = function(options)//host, port, username, pass) 
{
	...
	self.silent = false; // this flag is used if no logs are supposed to be printed
	self.showDataLog = true;
	self.sessionId = null;
	self.queuedPaused = false;

	var startPath = '/wd/hub';
...
//	defaultOptions = self.extend(defaultOptions, options);
	...
	{
		self.showCommandLog = false;
		self.showDataLog = false;
		self.silent = true;
	}
...
//	console.log("fulllRequestOptions", fulllRequestOptions)
	
	fulllRequestOptions.headers = {
		'content-type': 'application/json',
		'charset': 'charset=UTF-8'
	}
	
	//console.log(fulllRequestOptions)
