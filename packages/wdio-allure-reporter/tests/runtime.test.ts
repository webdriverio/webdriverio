...
describe('reporter reporter api', () => {
    it('should pass correct data from addLabel', () => {
        ...
        expect(utils.tellReporter).toHaveBeenCalledWith(events.addLabel, {
            name: 'customLabel',
            value: 'Label',
        })
    })
    ...
    it('should pass correct data from addStory', () => {
        ...
        expect(utils.tellReporter).toHaveBeenCalledTimes(1)
        expect(utils.tellReporter).toHaveBeenCalledWith(events.addStory, {
            storyName: 'Story',
        })
    })
    ...
    it('should pass correct data from addFeature', () => {
        ...
        expect(utils.tellReporter).toHaveBeenCalledTimes(1)
        expect(utils.tellReporter).toHaveBeenCalledWith(events.addFeature, {
            featureName: 'foo',
        })
    })
    ...
    it('should pass correct data from addSeverity', () => {
        ...
        expect(utils.tellReporter).toHaveBeenCalledTimes(1)
        expect(utils.tellReporter).toHaveBeenCalledWith(events.addSeverity, {
            severity: 'foo',
        })
    })
    ...
    it('should pass correct data from addIssue', () => {
        reporter.addIssue('1')
        expect(utils.tellReporter).toHaveBeenCalledTimes(1)
        expect(utils.tellReporter).toHaveBeenCalledWith(events.addIssue, {
            issue: '1',
        })
    })
    ...
    it('should pass correct data from addTestId', () => {
        ...
        expect(utils.tellReporter).toHaveBeenCalledTimes(1)
        expect(utils.tellReporter).toHaveBeenCalledWith(events.addTestId, {
            testId: '2',
        })
    })
    ...
    it('should pass correct data from addEnvironment', () => {
        ...
        expect(utils.tellReporter).toHaveBeenCalledTimes(1)
        expect(utils.tellReporter).toHaveBeenCalledWith(events.addEnvironment, {
            name: 'foo',
            value: 'bar',
        })
    })
    ...
    it('should pass correct data from addDescription', () => {
        ...
        expect(utils.tellReporter).toHaveBeenCalledTimes(1)
        expect(utils.tellReporter).toHaveBeenCalledWith(events.addDescription, {
            description: 'foo',
    ...
    it('should pass correct data from addStep', () => {
        reporter.addStep(
            'foo',
            { name: 'bar', content: 'baz', type: 'text/plain' },
            stepStatuses.FAILED,
        )
        expect(utils.tellReporter).toHaveBeenCalledTimes(1)
        const step = {
            step: {
                attachment: { content: 'baz', name: 'bar', type: 'text/plain' },
                status: 'failed',
                title: 'foo',
            },
        }
    ...
    it('should support end step', () => {
        ...
        expect(utils.tellReporter).toHaveBeenCalledTimes(1)
        expect(utils.tellReporter).toHaveBeenCalledWith(
            events.endStep,
            'passed',
        )
    })
    ...
    it('should throw exception for incorrect status for addStep', () => {
        ...
        const cb = () => {
            reporter.addStep('foo', { content: 'baz' }, 'invalid-status')
        }
        expect(cb).toThrowError(
            'Step status must be passed or failed or broken or canceled or skipped. You tried to set "invalid-status"',
        )
    })
    ...
    it('should throw exception for incorrect status for endStep', () => {
        // @ts-expect-error invalid param
        const cb = () => {
            reporter.endStep('invalid-status')
        }
        expect(cb).toThrowError(
            'Step status must be passed or failed or broken or canceled or skipped. You tried to set "invalid-status"',
        )
    ...
    it('should pass correct data from addArgument', () => {
        ...
        expect(utils.tellReporter).toHaveBeenCalledTimes(1)
        expect(utils.tellReporter).toHaveBeenCalledWith(events.addArgument, {
            name: 'os',
            value: 'osx',
        })
    })
    ...
    describe('addAttachment', () => {
        ...
        scenarios.forEach(({ title, actualType, content, name, type }) => {
            it(title, () => {
                ...
                expect(utils.tellReporter).toBeCalledWith(
...
describe('event listeners', () => {
    ...
    Object.values(events).forEach((eventName: any) => {
        it(`${eventName} should have listener defined`, () => {
            expect(process.listeners(eventName).length).toBeGreaterThanOrEqual(
                1,
            )
        })
    })
...
describe('dumpJSON', () => {
    ...
    it('valid json', () => {
        ...
        expect(reporterInstance['_allure'].addAttachment).toBeCalledWith(
            'foobar',
            '{\n  "foo": "bar"\n}',
            'application/json',
        )
