...
describe('Appium launcher', () => {
    ...
    describe('onPrepare', () => {
        ...
        test('should set correct config properties using parallel multiremote', async () => {
            ...
            expect(capabilities[0].browserA.hostname).toBe('localhost')
            ...
            expect(capabilities[0].browserB.hostname).toBe('localhost')
            ...
            expect(capabilities[1].browserC.hostname).toBe('localhost')
            ...
            expect(capabilities[1].browserD.hostname).toBe('localhost')
