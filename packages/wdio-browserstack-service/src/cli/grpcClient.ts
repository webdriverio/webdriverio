...
export class GrpcClient {
    ...
    async startBinSession() {
      ...
      try {
          ...
          return new Promise((resolve, reject) => {
            this.client.startBinSession(request, (error: Error, response: any) => {
                if (error) {
    ...
    async connectBinSession() {
      ...
      try {
          ...
          const response = await new Promise((resolve, reject) => {
              this.client.connectBinSession(request, (error: Error, response: any) => {
                  if (error) {
    ...
    async stopBinSession() {
      ...
      try {
          ...
          const response = await new Promise((resolve, reject) => {
              this.client.stopBinSession(request, (error: Error, response: any) => {
                  if (error) {
