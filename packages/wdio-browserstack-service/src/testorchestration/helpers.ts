 ...
 */
function getSizeOfJsonObjectInBytes(obj: any): number {
    try {
 ...
 */
function checkAndTruncateVcsInfo(gitMetaData: Record<string, any>): Record<string, any> {
 ...
 * Get git metadata
 */
export function getGitMetadata(): Record<string, any> {
    try {
        // Find git repo root
 ...
 */
function isValidGitResult(result: Record<string, any>): boolean {
    return (
 ...
 */
export function getGitMetadataForAISelection(folders: string[] = []): any[] {
