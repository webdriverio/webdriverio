...
import { sendFinish, sendStart } from '../../src/instrumentation/funnelInstrumentation'
import { BStackLogger } from '../../src/bstackLogger'
import fs from 'node:fs'
import got from 'got'
import { FUNNEL_INSTRUMENTATION_URL } from '../../src/constants'
...
describe('funnelInstrumentation', () => {
    ...
    it('saveFunnelData writes data to file and returns file path', () => {
        BStackLogger.ensureLogsFolder = jest.fn()
