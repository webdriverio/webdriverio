...
export const SUPPORTED_PACKAGES = {
    runner: [
        {
            name: 'local - for e2e testing of web and mobile applications',
            value: '@wdio/local-runner$--$local',
        },
        {
            name: 'browser - for unit and component testing in the browser',
            value: '@wdio/browser-runner$--$browser',
        },
    ],
    framework: [
        {
            name: 'Mocha (https://mochajs.org/)',
            value: '@wdio/mocha-framework$--$mocha',
        },
        {
            name: 'Jasmine (https://jasmine.github.io/)',
            value: '@wdio/jasmine-framework$--$jasmine',
        },
        {
            name: 'Cucumber (https://cucumber.io/)',
    ...
    reporter: [
        ...
        {
            name: 'cucumber-json',
            value: 'wdio-cucumberjs-json-reporter$--$cucumberjs-json',
        },
        {
            name: 'mochawesome',
    ...
    service: [
        ...
        {
            name: 'geckodriver',
            value: 'wdio-geckodriver-service$--$geckodriver',
        },
        { name: 'edgedriver', value: 'wdio-edgedriver-service$--$edgedriver' },
        {
            name: 'safaridriver',
            value: 'wdio-safaridriver-service$--$safaridriver',
        },
        // internal
        {
        ...
        // external
        {
            name: 'eslinter-service',
            value: 'wdio-eslinter-service$--$eslinter',
        },
        ...
        {
            name: 'cucumber-viewport-logger',
            value: 'wdio-cucumber-viewport-logger-service$--$cucumber-viewport-logger',
        },
        { name: 'intercept', value: 'wdio-intercept-service$--$intercept' },
        { name: 'docker', value: 'wdio-docker-service$--$docker' },
        {
            name: 'image-comparison',
            value: 'wdio-image-comparison-service$--$image-comparison',
        },
        {
        ...
        {
            name: 'winappdriver',
            value: 'wdio-winappdriver-service$--$winappdriver',
        },
        {
            name: 'ywinappdriver',
            value: 'wdio-ywinappdriver-service$--$ywinappdriver',
        },
        {
            name: 'performancetotal',
            value: 'wdio-performancetotal-service$--$performancetotal',
        },
        {
            name: 'cleanuptotal',
            value: 'wdio-cleanuptotal-service$--$cleanuptotal',
        },
        {
            name: 'aws-device-farm',
            value: 'wdio-aws-device-farm-service$--$aws-device-farm',
        },
        {
            name: 'ocr-native-apps',
            value: 'wdio-ocr-service$--$ocr-native-apps',
        },
        { name: 'ms-teams', value: 'wdio-ms-teams-service$--$ms-teams' },
        { name: 'tesults', value: 'wdio-tesults-service$--$tesults' },
        {
            name: 'azure-devops',
            value: '@gmangiapelo/wdio-azure-devops-service$--$azure-devops',
        },
        {
            name: 'google-Chat',
            value: 'wdio-google-chat-service$--$google-chat',
        },
        {
            name: 'qmate-service',
            value: '@sap_oss/wdio-qmate-service$--$qmate-service',
        },
    ],
} as const
...
export const SUPPORTED_BROWSER_RUNNER_PRESETS = [
    ...
    { name: 'Vue.js (https://vuejs.org/)', value: '@vitejs/plugin-vue$--$vue' },
    {
        ...
        value: '@sveltejs/vite-plugin-svelte$--$svelte',
    },
    {
        name: 'React (https://reactjs.org/)',
        value: '@vitejs/plugin-react$--$react',
    },
    {
        name: 'Preact (https://preactjs.com/)',
        value: '@preact/preset-vite$--$preact',
    },
    { name: 'Other', value: '' },
]
...
export const PROTOCOL_OPTIONS = ['https', 'http'] as const

export const REGION_OPTION = ['us', 'eu', 'apac'] as const
...
export const QUESTIONNAIRE = [
    {
        ...
        when: /* istanbul ignore next */ () =>
            SUPPORTED_PACKAGES.runner.length > 1,
    },
    {
        type: 'list',
        name: 'preset',
    ...
    },
    {
        ...
        message:
            'Do you like to use Testing Library (https://testing-library.com/) as test utility?',
        default: false,
        // only ask if there are more than 1 runner to pick from
        when: /* istanbul ignore next */ (answers: Questionnair) =>
            ...
            TESTING_LIBRARY_PACKAGES[
                convertPackageHashToObject(answers.preset).short
            ],
    },
    {
        type: 'list',
    ...
    },
    {
        ...
        when: /* istanbul ignore next */ (answers: Questionnair) =>
            answers.backend.toString().indexOf('different service') > -1,
    },
    {
        type: 'input',
        name: 'port',
    ...
    },
    {
        ...
        when: /* istanbul ignore next */ (answers: Questionnair) =>
            answers.backend === 'In the cloud using Experitest',
    },
    {
        type: 'input',
        name: 'expEnvHostname',
    ...
    },
    {
        ...
        when: /* istanbul ignore next */ (answers: Questionnair) =>
            answers.backend
                .toString()
                .startsWith('In the cloud using Browserstack'),
    },
    {
        type: 'input',
        name: 'env_key',
    ...
    },
    {
        ...
        when: /* istanbul ignore next */ (answers: Questionnair) =>
            answers.backend === 'In the cloud using Sauce Labs',
    },
    {
        type: 'input',
        name: 'env_key',
    ...
    },
    {
        ...
        name: 'hostname',
        message:
            'What is the IP or URI to your Selenium standalone or grid server?',
        default: 'localhost',
        when: /* istanbul ignore next */ (answers: Questionnair) =>
            answers.backend.toString().indexOf('own Selenium cloud') > -1,
    },
    {
        type: 'input',
        name: 'port',
        message:
            'What is the port which your Selenium standalone or grid server is running on?',
        default: '4444',
        when: /* istanbul ignore next */ (answers: Questionnair) =>
            answers.backend.toString().indexOf('own Selenium cloud') > -1,
    },
    ...
    },
    {
        ...
        default: (answers: Questionnair) =>
            getDefaultFiles(answers, './test/specs/**/*'),
        when: /* istanbul ignore next */ (answers: Questionnair) =>
    ...
    },
    {
        ...
        when: /* istanbul ignore next */ (answers: Questionnair) =>
            answers.framework.includes('cucumber'),
    },
    {
        type: 'input',
        ...
        default: (answers: Questionnair) =>
            getDefaultFiles(answers, './features/step-definitions/steps'),
        when: /* istanbul ignore next */ (answers: Questionnair) =>
            answers.framework.includes('cucumber'),
    },
    {
    ...
    },
    {
        ...
        default: './',
        when: /* istanbul ignore next */ (answers: Questionnair) =>
            answers.reporters.includes('junit'),
    },
    {
        type: 'input',
        name: 'outputDir',
        ...
        default: './',
        when: /* istanbul ignore next */ (answers: Questionnair) =>
            answers.reporters.includes('json'),
    },
    {
        type: 'input',
        name: 'outputDir',
        message:
            'In which directory should the mochawesome json reports get stored?',
        default: './',
        when: /* istanbul ignore next */ (answers: Questionnair) =>
            answers.reporters.includes('mochawesome'),
    },
    {
        type: 'input',
        name: 'baseUrl',
