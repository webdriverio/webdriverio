...
vi.mock('lighthouse/core/audits/diagnostics')
vi.mock('lighthouse/core/audits/mainthread-work-breakdown')
vi.mock('lighthouse/core/audits/metrics')
vi.mock('lighthouse/core/audits/server-response-time')
vi.mock('lighthouse/core/audits/metrics/cumulative-layout-shift')
vi.mock('lighthouse/core/audits/metrics/first-contentful-paint')
vi.mock('lighthouse/core/audits/metrics/largest-contentful-paint')
vi.mock('lighthouse/core/audits/metrics/speed-index')
vi.mock('lighthouse/core/audits/metrics/interactive')
vi.mock('lighthouse/core/audits/metrics/total-blocking-time')
vi.mock('lighthouse/core/config/default-config')
vi.mock('lighthouse/core/audits/installable-manifest')
vi.mock('lighthouse/core/audits/service-worker')
vi.mock('lighthouse/core/audits/splash-screen')
vi.mock('lighthouse/core/audits/themed-omnibox')
vi.mock('lighthouse/core/audits/content-width')
vi.mock('lighthouse/core/audits/viewport')
vi.mock('lighthouse/core/audits/apple-touch-icon')
vi.mock('lighthouse/core/audits/maskable-icon')
