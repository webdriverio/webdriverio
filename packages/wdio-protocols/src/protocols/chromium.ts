    ...
    '/session/:sessionId/alert': {
        GET: {
            ...
            returns: {
                ...
                name: 'isAlertOpen',
                description:
                    '`true` or `false` based on whether simple dialog is present or not.',
            },
        },
    },
    '/session/:sessionId/autoreport': {
        GET: {
            ...
            returns: {
                ...
                description:
                    '`true` or `false` based on whether auto reporting is enabled.',
            },
        },
        POST: {
            ...
            parameters: [
                {
                    ...
                    type: 'boolean',
                    description:
                        '`true` if auto reporting should be enabled, use `false` to disable previously enabled auto reporting.',
                    required: true,
                },
            ],
            returns: {
                ...
                description:
                    "In case first browser error already occured prior to executing this command it will throw unknown error as response, which is an object with 'message' key describing first browser error. Otherwise it returns `null` on success.",
            },
        },
    },
    '/session/:sessionId/is_loading': {
        GET: {
            ...
            returns: {
                ...
                name: 'isLoading',
                description:
                    '`true` or `false` based on whether active window handle is loading or not.',
            },
        },
    },
    ...
    '/session/:sessionId/network_connection': {
        GET: {
            ...
            returns: {
                ...
                name: 'connectionType',
                description:
                    'A bitmask to represent the network connection type. Airplane Mode (`1`), Wi-Fi only (`2`), Wi-Fi and data (`6`), 4G (`8`), 3G (`10`), 2G (`20`). By default [Wi-Fi and data are enabled](https://github.com/bayandin/chromedriver/blob/v2.45/chrome/chrome_desktop_impl.cc#L36-L37).',
            },
        },
        POST: {
            ...
            parameters: [
                {
                    ...
                    type: 'object',
                    description:
                        'Object containing ConnectionType, set bitmask as value for `type` key in object. Airplane Mode (`1`), Wi-Fi only (`2`), Wi-Fi and data (`6`), 4G (`8`), 3G (`10`), 2G (`20`).',
                    required: true,
                },
            ],
            returns: {
                ...
                name: 'connectionType',
                description:
                    'A bitmask to represent the network connection type. Value should match specified `type` in object, however device might not be capable of the network connection type requested.',
            },
        },
    },
    '/session/:sessionId/chromium/network_conditions': {
        GET: {
            ...
            returns: {
                ...
                description:
                    'Object containing network conditions for `offline`, `latency`, `download_throughput` and `upload_throughput`. Network conditions must be set before it can be retrieved.',
            },
        },
        POST: {
            ...
            parameters: [
                {
                    ...
                    type: 'object',
                    description:
                        'Object containing network conditions which are `latency`, `throughput` (or `download_throughput`/`upload_throughput`) and `offline` (optional).',
                    required: true,
                },
                {
                    name: 'network_name',
                    type: 'string',
                    description:
                        'Name of [network throttling preset](https://github.com/bayandin/chromedriver/blob/v2.45/chrome/network_list.cc#L12-L25). `GPRS`, `Regular 2G`, `Good 2G`, `Regular 3G`, `Good 3G`, `Regular 4G`, `DSL`, `WiFi` or `No throttling` to disable. When preset is specified values passed in first argument are not respected.',
                    required: false,
                },
            ],
        },
            ...
            parameters: [
                {
                    ...
                    type: 'string',
                    description:
                        'Name of the command (e.g. [`Browser.close`](https://chromedevtools.github.io/devtools-protocol/1-3/Browser#method-close)).',
                    required: true,
                },
                {
                    name: 'params',
                    type: 'object',
                    description:
                        'Parameters to the command. In case no parameters for command, specify an empty object.',
                    required: true,
                },
            ],
        },
    ...
    '/session/:sessionId/chromium/send_command_and_get_result': {
        POST: {
            ...
            parameters: [
                {
                    ...
                    type: 'string',
                    description:
                        'Name of the command which returns a result (e.g. [`Network.getAllCookies`](https://chromedevtools.github.io/devtools-protocol/1-3/Network#method-getAllCookies)).',
                    required: true,
                },
                {
                    name: 'params',
            ...
            returns: {
                ...
                name: 'result',
                description:
                    "Either the return value of your command, or the error which was the reason for your command's failure.",
            },
        },
    },
            ...
            parameters: [
                {
                    ...
                    type: 'string',
                    description:
                        'Extension id of app to be launched, as defined in chrome://extensions.',
                    required: true,
                },
            ],
        },
    ...
    '/session/:sessionId/element/:elementId/value': {
        GET: {
            ...
            returns: {
                ...
                name: 'value',
                description:
                    'Current value of the element. In case specified element is not a form control element, it will return `null`.',
            },
        },
    },
