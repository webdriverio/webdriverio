export default {
    '/session/:sessionId/element/:elementId/pageIndex': {
        GET: {
            ...
            deprecated: 'In Appium 2.0, this method is marked as deprecated and currently has no available alternatives. No longer supported since Appium 3.',
            parameters: [],
            returns: {
                type: 'string',
                name: 'pageIndex',
    ...
    '/session/:sessionId/network_connection': {
        GET: {
            ...
            deprecated: 'For Appium Android automation, use `driver.execute(\'mobile: getConnectivity\', { ... })` instead. No longer supported since Appium 4.',
            parameters: [],
            returns: {
                type: 'number',
                name: 'connectionType',
        ...
        POST: {
            ...
            ref: 'https://github.com/SeleniumHQ/mobile-spec/blob/master/spec-draft.md#device-modes',
            deprecated: 'For Appium Android automation, use `driver.execute(\'mobile: setConnectivity\', { ... })` instead. No longer supported since Appium 4.',
            parameters: [
                {
                    name: 'type',
                    type: 'number',
    ...
    '/session/:sessionId/touch/perform': {
        GET: {
            ...
            deprecated: 'For Appium, use `driver.performActions(...)` instead. No longer supported since Appium 3.',
            parameters: [
                {
                    name: 'actions',
                    type: 'object[]',
    ...
    '/session/:sessionId/receive_async_response': {
        POST: {
            ...
            ref: 'https://github.com/appium/appium-base-driver/blob/master/docs/mjsonwp/protocol-methods.md#mobile-json-wire-protocol-endpoints',
            deprecated: 'For Appium, use `driver.executeAsyncScript(...)` instead. No longer supported since Appium 4.',
            parameters: [
                {
                    name: 'status',
                    type: 'string',
