...
export default class SpecReporter extends WDIOReporter {
    ...
    printCurrentStats(stat: TestStats | HookStats | SuiteStats) {
        ...
        const contentTest =
            ...
            ` » ${chalk[this.getColor(state)]('[')} ${this._suiteName} ${chalk[
                this.getColor(state)
            ](']')}`
    ...
    getEnviromentCombo(
        ...
        const browser = isMultiremote
            ? 'MultiremoteBrowser'
            : caps.browserName || caps.browser
        /**
