...
function isIOS(capabilities?: Capabilities.DesiredCapabilities) {
    ...
    return Boolean(
        (capabilities.platformName &&
            capabilities.platformName.match(/iOS/i)) ||
            (capabilities.deviceName &&
                capabilities.deviceName.match(/(iPad|iPhone)/i)),
    )
}
...
function isAndroid(capabilities?: Capabilities.Capabilities) {
    ...
    return Boolean(
        (capabilities.platformName &&
            capabilities.platformName.match(/Android/i)) ||
            (capabilities.browserName &&
                capabilities.browserName.match(/Android/i)),
    )
}
 ...
 */
export function capabilitiesEnvironmentDetector(
 ...
 * @return {Object}                         object with environment flags
 */
export function webdriverEnvironmentDetector(
    capabilities: Capabilities.Capabilities,
) {
    return {
        isChrome: isChrome(capabilities),
