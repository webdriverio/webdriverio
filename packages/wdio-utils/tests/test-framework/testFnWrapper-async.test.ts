        ...
        const stackTraces = [
            {
                fullStack : `
                    ...
                    at Context.executeAsync (/foo/bar/baz/node_modules/@testplane/wdio-utils/build/shim.js:331:27)
                    at Context.testFrameworkFnWrapper (/foo/bar/baz/node_modules/@testplane/wdio-utils/build/test-framework/testFnWrapper.js:50:32)
            ...
            },
            {
                fullStack : `
                    ...
                    at async Element.wrapCommandFn (/foo/bar/node_modules/@testplane/wdio-utils/build/shim.js:137:29)
