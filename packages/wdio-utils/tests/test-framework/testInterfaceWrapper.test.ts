...
import {
    ...
    wrapTestFunction,
} from '../../src/test-framework/testInterfaceWrapper.js'

const testFunction = vi.fn(function (this: any, specTitle, cb) {
    return cb.call(this, 'foo', 'bar')
})
const hookFunction = vi.fn(function (this: any, cb) {
    return cb.call(this, 'foo', 'bar')
})
...
describe('runTestInFiberContext', () => {
    it('should wrap skip and only functions', () => {
        const skipFn = () => {}
        const onlyFn = function (...args: any[]) {
            return global.foobar(...args)
        }
