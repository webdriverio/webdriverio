...
import { deleteSession, newSession } from './mocks/newSession.js'
...
export default class WebdriverMockService implements Services.ServiceInstance {
    ...
    init() {
        ...
        this._mock.command
            .getTitle()
            .times(Infinity)
            .reply(200, { value: 'Mock Page Title' })
        this._mock.command
            .getUrl()
            .times(Infinity)
            .reply(200, { value: 'https://mymockpage.com' })
        this._mock.command
            .getElementRect(ELEMENT_ID)
            .times(2)
            .reply(200, { value: { width: 1, height: 2, x: 3, y: 4 } })
        this._mock.command
            .getElementRect(ELEMENT_ALT)
            .times(3)
            .reply(200, { value: { width: 10, height: 20, x: 30, y: 40 } })
        this._mock.command
            .getElementRect(ELEMENT_REFETCHED)
            .times(1)
            .reply(200, { value: { width: 1, height: 2, x: 3, y: 4 } })
    ...
    before(
        ...
        this._browser.addCommand(
            ...
            this.waitForElementScenario.bind(this),
        )
        this._browser.addCommand(
            'isNeverDisplayedScenario',
            this.isNeverDisplayedScenario.bind(this),
        )
        this._browser.addCommand(
            'isEventuallyDisplayedScenario',
            this.isEventuallyDisplayedScenario.bind(this),
        )
        this._browser.addCommand(
            'staleElementRefetchScenario',
            this.staleElementRefetchScenario.bind(this),
        )
        this._browser.addCommand(
            'customCommandScenario',
            this.customCommandScenario.bind(this),
        )
        this._browser.addCommand(
            'customSelectorScenario',
            this.customSelectorScenario.bind(this),
        )
        this._browser.addCommand(
            'waitForDisplayedScenario',
            this.waitForDisplayedScenario.bind(this),
        )
        this._browser.addCommand(
            'cucumberScenario',
            this.cucumberScenario.bind(this),
        )
        this._browser.addCommand('clickScenario', this.clickScenario.bind(this))
        this._browser.addCommand(
            'isExistingScenario',
            this.isExistingScenario.bind(this),
        )
        this._browser.addCommand(
            'isNotExistingScenario',
            this.isNotExistingScenario.bind(this),
        )
        this._browser.addCommand(
            'multiremoteFetch',
            this.multiremoteFetch.bind(this),
        )
        this._browser.addCommand(
            'asyncIterationScenario',
            this.asyncIterationScenario.bind(this),
        )
        this._browser.addCommand(
            'parentElementChaining',
            this.parentNextPreviousElementChaining.bind(this),
        )
    }
    ...
    clickScenario() {
        ...
        this._mock.command
            .findElement()
            .times(2)
            .reply(200, { value: elemResponse })
        this._mock.command
            .elementClick(ELEMENT_ID)
            .once()
    ...
    isExistingScenario() {
        ...
        this._mock.command
            ...
            .reply(200, { value: elemResponse })
        this._mock.command
            .findElementFromElement(ELEMENT_ID)
            .times(2)
            .reply(200, { value: elemResponse })
        this._mock.command
            .findElementsFromElement(ELEMENT_ID)
            .times(2)
            .reply(200, { value: [elemResponse] })
    }
    ...
    staleElementRefetchScenario() {
        ...
        this._mock.command
            .elementClick(ELEMENT_REFETCHED)
            .times(4)
            .reply(200, { value: null })
    ...
    asyncIterationScenario() {
        ...
        this._mock.command
            .findElements()
            .reply(200, { value: [elemResponse, elem2Response] })
    ...
    parentNextPreviousElementChaining() {
        ...
        this._mock.command
            .executeScript()
            .reply(200, { value: elemParentResponse })
        this._mock.command
            .getElementText(ELEMENT_REFETCHED)
            .reply(200, { value: 'some element text' })
    }
    ...
    customCommandScenario(times = 1) {
        ...
        this._mock.command
            .findElement()
            .times(times)
            .reply(200, { value: elemAltResponse })
        this._mock.command
            .executeScript()
            .times(times)
            .reply(200, { value: '2' })
        ...
        this._mock.command
            .deleteAllCookies()
            .times(times)
            .reply(200, { value: 'deleteAllCookies' })
    }
    ...
    customSelectorScenario() {
        ...
        this._mock.command
            ...
            .reply(200, { value: elemAltResponse })
        this._mock.command
            .findElementFromElement(ELEMENT_ALT)
            .reply(200, { value: elemResponse })
    }
