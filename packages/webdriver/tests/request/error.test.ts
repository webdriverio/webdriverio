...
import { WebDriverResponseError } from '../../src/request/error.js'
...
describe('WebDriverResponseError', () => {
    it('captures errors without body', () => {
        ...
        expect(error.message).toBe('WebDriverResponseError: Response has empty body when running "url" with method "POST"')
    ...
    it('captures errors with unknown body', () => {
        ...
        expect(error.message).toBe('WebDriverResponseError: unknown error when running "url" with method "POST"')
    ...
    it('captures Firefox errors', () => {
        ...
        expect(error.message).toBe('WebDriverResponseError: bar when running "url" with method "POST"')
    })
    ...
    it('captures Chrome errors', () => {
        ...
        expect(error.message).toBe('WebDriverResponseError: stale element reference when running "url" with method "POST"')
    ...
    it('captures errors with message', () => {
        ...
        expect(error.message).toBe('WebDriverResponseError: message error when running "url" with method "POST"')
    ...
    it('captures errors with class', () => {
        ...
        expect(error.name).toBe('WebDriver Error')
        expect(error.message).toBe('WebDriverResponseError: class error when running "url" with method "POST"')
        expect(error.stack).toMatch('WebDriver Error')
    ...
    it('captures invalid selector errors', () => {
        ...
        expect(error.message).toMatchInlineSnapshot(`"WebDriverResponseError: The selector "!!" used with strategy "css selector" is invalid! when running "url" with method "POST" and args "{"using":"css selector","value":"!!"}""`)
    })
    ...
    it('captures unknown command errors', () => {
        ...
        expect(error.message).toMatchInlineSnapshot(`"WebDriverResponseError: Command not found: POST /some/command when running "url" with method "POST""`)
