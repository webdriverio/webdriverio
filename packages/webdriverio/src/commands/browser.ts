...
export default {
    ...
    pause, react$$, react$, reloadSession, request, savePDF, saveRecordingScreen, saveScreenshot,
    scroll, setCookies, setTimeout, setWindowSize, switchWindow, throttle, touchAction, uploadFile,
    url, waitUntil
}
