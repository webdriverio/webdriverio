 ...
 * @example https://github.com/webdriverio/example-recipes/blob/main/deleteCookies/example.js#L9-L29
 * @example https://github.com/webdriverio/example-recipes/blob/main/deleteCookies/example.js#L31-L35
 */
