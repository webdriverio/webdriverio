 ...
 * some browser driver are taking screenshots of the whole document (e.g. Geckodriver with
 * Firefox) and others only of the current viewport (e.g. Chromedriver with Chrome). If you
 * want to always be sure that the screenshot has the size of the whole document, use [wdio-screenshot](https://www.npmjs.com/package/wdio-screenshot)
