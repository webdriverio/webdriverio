...
export const getComputedRole = require('./element/getComputedRole').default
export const getComputedLabel = require('./element/getComputedLabel').default
...
export const nextElement = require('./element/nextElement').default
export const parentElement = require('./element/parentElement').default
export const previousElement = require('./element/previousElement').default
