 ...
 * @param {number=}         options.duration          The duration in milliseconds for the swipe. Default is `1000` ms. The lower the value, the faster the swipe.<br /><strong>MOBILE-NATIVE-APP-ONLY</strong>
