 ...
 * @param {object|boolean=} options                   options for `browser.swipe()`. Default for desktop/mobile web: <br/> `{ direction: 'down', duration: 1500, percent: 0.95, scrollableElement: WebdriverIO.Element }`
