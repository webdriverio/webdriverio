...
/**
 * Store restore functions per browser without retaining closed browser instances.
 */
export const restoreFunctions = new WeakMap<WebdriverIO.Browser, RestoreMap>()
