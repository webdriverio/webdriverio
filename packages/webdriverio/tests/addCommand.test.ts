...
describe('addCommand', () => {
    describe('remote', () => {
        ...
        test('should propagate custom element commands for all prototypes', async () => {
            ...
            // @ts-expect-error undefined custom command
            expect(await elems[0].myCustomElementCommand()).toBe(
                'foobar-.someRandomElement0',
            )
            // @ts-expect-error undefined custom command
            expect(await elems[1].myCustomElementCommand()).toBe(
                'foobar-.someRandomElement1',
            )
            // @ts-expect-error undefined custom command
            expect(await elems[2].myCustomElementCommand()).toBe(
                'foobar-.someRandomElement2',
            )
        })
        ...
        test('should propagate custom element commands to sub elements', async () => {
            ...
            // @ts-expect-error undefined custom command
            expect(await subElem.myCustomElementCommand()).toBe(
                'foobar-.subElem',
            )
        })
        ...
        test('should propagate custom sub element command back to element', async () => {
            ...
            // @ts-expect-error undefined custom command
            expect(await otherElem.myCustomElementCommand()).toBe(
                'foobar-#otherFoo',
            )
            ...
            // @ts-expect-error undefined custom command
            expect(await otherSubElem.myCustomElementCommand()).toBe(
                'foobar-.otherSubElem',
            )
        })
    ...
    describe('multiremote', () => {
        test('should allow to register custom commands to multiremote instance', async () => {
            ...
            browser.addCommand(
                'myCustomCommand',
                async function (this: WebdriverIO.Browser, param: any) {
            ...
            // @ts-expect-error undefined custom command
            const { param, commandResult } = await browser.myCustomCommand(
                'barfoo',
            )
        ...
        test('should allow to register custom commands to a single multiremote instance', async () => {
            ...
            browser.browserA.addCommand(
                'myOtherCustomCommand',
                async function (this: WebdriverIO.Browser, param: any) {
                    const commandResult = await this.execute(() => 'foobar')
                    return { param, commandResult }
                },
            ...
            expect(typeof browser.myOtherCustomCommand).toBe('undefined')
            // @ts-expect-error undefined custom command
            expect(typeof browser.browserB.myOtherCustomCommand).toBe(
                'undefined',
            )
            // @ts-expect-error undefined custom command
            expect(typeof browser.browserA.myOtherCustomCommand).toBe(
                'function',
            )
            // @ts-expect-error undefined custom command
            const { param, commandResult } =
                await browser.browserA.myOtherCustomCommand('barfoo')
            expect(param).toBe('barfoo')
        ...
        test('should not allow to call custom multi browser commands on elements', async () => {
            ...
            // @ts-expect-error undefined custom command
            expect(typeof elem.browserA.myCustomOtherOtherCommand).toBe(
                'undefined',
            )
            // @ts-expect-error undefined custom command
            expect(typeof elem.browserB.myCustomOtherOtherCommand).toBe(
                'undefined',
            )
        })
    })
