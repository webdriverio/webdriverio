...
describe('click test', () => {
    it('should allow to left click on an element without passing a button type', async () => {
        ...
        expect(request.mock.calls[2][0].uri.path).toBe('/session/foobar-123/element/some-elem-123/click')
    })
    ...
    it('should allow to left click on an element by passing a button type', async () => {
        ...
        expect(request.mock.calls[2][0].uri.path).toBe('/session/foobar-123/actions')
    ...
    it('should allow to left click on an element (no w3c)', async () => {
        ...
        expect(request.mock.calls[3][0].uri.path).toBe('/session/foobar-123/moveto')
        expect(request.mock.calls[3][0].body).toStrictEqual({ element: 'some-elem-123', xoffset: 25, yoffset: 15 })
        expect(request.mock.calls[4][0].uri.path).toBe('/session/foobar-123/click')
