...
describe('toggleAirplaneMode', () => {
    ...
    describe('legacy driver fallback (mobile: setConnectivity returns unknown method)', () => {
        ...
        it('should fall back to appiumToggleAirplaneMode and log a warning', async () => {
            vi.spyOn(browser, 'execute').mockRejectedValue(new Error('unknown method: mobile: setConnectivity'))
            const appiumSpy = vi.spyOn(browser, 'appiumToggleAirplaneMode').mockResolvedValue(undefined)
        ...
        it('should fall back to appiumToggleAirplaneMode on unknown command', async () => {
