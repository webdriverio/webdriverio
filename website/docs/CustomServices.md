...
- enhance the [service list](https://github.com/webdriverio/webdriverio/blob/main/infra/docs/src/3rd-party/services.json) for adding your docs to the official Webdriver.io page
