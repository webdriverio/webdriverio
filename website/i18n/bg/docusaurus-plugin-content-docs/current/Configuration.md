...
Type: `String` Default: `process.env.WEBDRIVER_CACHE_DIR || os.tmpdir()`
...
Type: `Object`|`Object[]` Default: `[{ maxInstances: 5, browserName: 'firefox' }]`
...
Type: `Number` Default: `0` (don't bail; run all tests)
...
Type: `String` Default: `mocha` Options: `mocha` | `jasmine`
...
Type: `Object` Default: `{ timeout: 10000 }`
