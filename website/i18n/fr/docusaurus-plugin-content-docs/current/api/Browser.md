...
Cela peut être utile si, par exemple, vous souhaitez définir des sélecteurs dans vos [objets de page](PageObjects.md) en fonction du type d'appareil, comme ceci :
