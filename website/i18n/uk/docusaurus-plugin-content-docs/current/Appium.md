...
Ми рекомендуємо використовувати [Appium](https://appium.io/), щоб полегшити тестування на цих платформах. You can get an overview on Appium on their [official documentation page](https://appium.io/docs/en/2.0/intro/).
