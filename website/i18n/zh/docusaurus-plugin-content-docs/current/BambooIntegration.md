...
1. Open your Bamboo project
    ...
    I will go with the default stage and job. I will go with the default stage and job. In your case, you can create your own stages and jobs
...
> **Task: 3** Add *jUnit Parser* task to parse your saved test results. Please specify the test results directory here (you can use Ant style patterns as well) Please specify the test results directory here (you can use Ant style patterns as well)
...
Once the above *rocket science* is done, please enable the plan and run it. Your final output will be like: Your final output will be like:
...
Yay!! That's all. Yay!! That's all. You have successfully integrated your WebdriverIO tests in Bamboo.
