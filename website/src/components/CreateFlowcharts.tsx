...
const setupTest = `graph TD
        ...
        INITTESTFRAMEWORK["Test framework from the wdio.conf. js property is<br>initialized usingthe @testplane/wdio-utils initializePlugin method.<br> <br>Supported frameworks include @wdio/mocha-framework,<br>@wdio/cucumber-framework and @wdio/jasmine-framework."]-->
