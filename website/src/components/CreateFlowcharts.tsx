...
const runRepl = `graph TD
        ...
        INSTANTIATELAUNCHER["Creates @wdio/cli:launcher instance<br>1) Set log level<br>2) Worker count equals number<br>of specs * caps array length<br>3)Create a new runnner instance<br>using @testplane/utils:initializePlugin<br>4. Create CLI Interface instance.<br>5. Setup interface job:start,<br>job:end event listeners"]-->
...
const setupTest = `graph TD
        ...
        INITTESTFRAMEWORK["Test framework from the wdio.conf. js property is<br>initialized usingthe @testplane/utils initializePlugin method.<br> <br>Supported frameworks include @wdio/mocha-framework,<br>@wdio/cucumber-framework and @wdio/jasmine-framework."]-->
...
const graphData = `
    graph LR
        ...
        RUNNER
        GLOBAL["GLOBALS<br>@wdio/sync<br>@wdio/config<br>@testplane/wdio-logger<br>@testplane/utils"]
    `
