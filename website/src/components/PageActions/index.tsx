...
export default function PageActions () {
    ...
    const links = [
        { label: 'View as Markdown', description: 'Open this page as plain text', href: markdownPath, icon: <MarkdownIcon /> },
        { label: 'Open in Codex', description: 'Ask questions about this page', href: `https://chatgpt.com/codex?prompt=${prompt}`, icon: <CodexIcon /> },
        { label: 'Open in Claude', description: 'Ask questions about this page', href: `https://claude.ai/new?q=${prompt}`, icon: <ClaudeIcon /> },
        { label: 'Open in Cursor', description: 'Use this page in your editor', href: `https://cursor.com/link/prompt?text=${prompt}`, icon: <CursorIcon /> },
    ]
...
function MarkdownIcon () {
    return (
        <svg width="18" height="12" viewBox="0 0 24 16" fill="currentColor" aria-hidden="true">
            <path d="M22.3 0H1.7C.8 0 0 .8 0 1.7v12.6C0 15.2.8 16 1.7 16h20.6c.9 0 1.7-.8 1.7-1.7V1.7C24 .8 23.2 0 22.3 0zM5.5 12.5V6.2l2.8 3.5 2.8-3.5v6.3h2.3V3.5h-2.3L8.3 8.2 5.5 3.5H3.2v9h2.3zm11.2 0-3.2-4h2.3V3.5h2.3v5h2.3l-3.7 4z" />
        </svg>
    )
}
