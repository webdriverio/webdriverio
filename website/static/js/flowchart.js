...
function createGraphSVG(graphIdAttribute) {
    ...
    let element = document.getElementById(graphIdAttribute)
...
function createFlowChart(graphText, graphIdAttribute = 'flowChartGraphDiv') {
    ...
    /*
    If svg graph node is existing remove, re-render with new graph.
    Used in the screens where the graph is toggled.
    */
    try {
